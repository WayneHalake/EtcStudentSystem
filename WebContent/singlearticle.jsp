			...
			<div class="row">
				...
				<!-- -------------------文章内容---------------------- -->
					<article class=" page type-page hentry clearfix">
						<h1 class="post-title">文章名称： ${singlearticle.articlename }</h1>
						<span class="category"><a href="#"
							title="View all posts in Server &amp; Database">发表人： ${singlearticle.username }</a></span>
						<span class="date">发表时间： ${singlearticle.publishedtime }</span>
						<p>文章内容：${singlearticle.articlecontent }</p>
					</article>
				<!-- -------------------文章内容-----end----------------- -->
						...
						<article class="faq-item active">
							...
							<div class="faq-answer">
								<div class="post-meta clearfix">
									...
									<form action="./CommentServlet?action=add&commenttype=articlecommenttable" onsubmit="return checkLogin()" method="post">
										<input type="hidden" name="id" value="${singlearticle.articleid }"/>
