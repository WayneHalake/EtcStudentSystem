					...
					<c:forEach items="${notes }" var="note">
						...
						<article class="format-standard type-post hentry clearfix">
							...
							<header class="clearfix">
								...
								<h3 class="post-title">
									<a href="./CommentServlet?type=note&id=${note.noteid }">${note.notename }</a>
								</h3>

								<div class="post-meta clearfix">
									<span class="date">${note.publishedtime }</span> <span
										class="category"><a href="#"
										title="View all posts in Server &amp; Database">${note.username }</a></span>
